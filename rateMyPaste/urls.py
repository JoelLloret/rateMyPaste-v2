...
urlpatterns = [
    ...
    path('mypokemon/create/', web_views.pokemon_create, name='pokemon_create'),
    path('mypokemon/<int:pk>/edit/', web_views.pokemon_edit, name='pokemon_edit'),
    path('mypokemon/<int:pk>/delete/', web_views.pokemon_delete, name='pokemon_delete'),
    path('mypokemon/<int:pk>/', web_views.pokemon_detail, name='pokemon_detail'),
    path('mypokemon/', web_views.pokemon_list, name='pokemon_list'),
    ...
    path('pokemons/', web_views.pokemons, name='pokemons'),
